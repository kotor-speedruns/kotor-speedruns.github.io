...
Any% Unrestricted Guide v1.1: Female Jedi Sentinel/Consular Route [/big]**[/center]
...
*3. Alternate Citadel Route* - This section details an alternate route for Citadel Station centered around the Exchange DLZ, which is extremely difficult.  While this route is faster, it is not recommended for any runner.
...
[section=Character Build and Equipment]
...
> Female Character, any class - Quick Character
...
**Prologue:**
QS and Map CS Skip to Hardsave
...
- Hardsave, then load the Ebon Hawk save (last in list)
- AMG via QS, Open Options, click "Exit Game", select "OK" and "Save Game" simultaneously
...
- This Hotshot activates the Dev Character
Cast Master Speed
...
- Hardsave, then load the Kolto Tank save (3rd from top)
- Use a QS AMG to perform the Hotshot as above
...
Talk to 3C-FD: 7
Immediately Hardsave during the fadeout
...
- Hardsave, then load Kolto Tank save (3rd from bottom)
- Use a QS AMG to perform a Hotshot
- This warps your party members to the Kolto Tank area
Coordinate Warp to Hangar Level
- Hardsave, then load Hangar Level save (3rd from top)
- Use a QS AMG to perform a Hotshot
...
Shoot 29 Sith soldiers during the turret minigame
Kreia accosts you

**Ebon Hawk:**
Kreia and Atton accost you: 6,2
...
Cast Master Speed before Chodo Habat accosts you
Hardsave
...
Talk to Luxa
*Optional:* Unequip the KillBlaster
Hotshot to Residential West:
- Hardsave, then load the terminal save (fourth from top)
- Use a QS AMG to perform a Hotshot
...
Add Kreia to your party
*Optional: If you unequipped earlier, equip Kreia with a KillBlaster*
Cast Master Speed
...
- Hardsave, then load Chodo Habat save (sixth from top)
- Use a QS AMG to perform a Hotshot

**Infiltrating Czerka:**
Swap to Kreia and talk to Chodo Habat
Hotshot to Cantina
- Hardsave, then load Cantina save (fourth from top)
- Use a QS AMG to perform a Hotshot
Activate Solo Mode
...
- Hardsave, then load the Auto Save (eighth from top)
- Use a QS AMG to perform a Hotshot
...
**Military Base:**
Add Bao-Dur and Kreia to party
Hotshot to Ebon Hawk:
- Hardsave, then load the Ebon Hawk cockpit save (last in list)
- Use a QS AMG to perform a Hotshot
} Unequip KillBlaster and Lightsaber from MC
Coordinate Warp to Military Base:
- Hardsave, then load the Military Base save (third from top)
- Use a QS AMG to perform a Hotshot
} Equip Kreia with KillBlaster in first slot and Lightsaber in second
...
Save Teleport with Kreia to hangar controls (or swap to MC if you were able to leave him there)
...
Click the Options icon to Hardsave
Hotshot to Czerka Office:
- Load the Czerka save (seventh from top)
- Use a QS AMG to perform a Hotshot
Add 3C-FD and Kreia to party
...
**Polar Academy:**
Coordinate Warp to Polar Academy
...
- This starts the endgame sequence
