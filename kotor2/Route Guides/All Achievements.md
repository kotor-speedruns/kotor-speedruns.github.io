...
This route completes all of the Aspyr Achievements(57) in KotOR II without the use of glitches. Timing begins upon clicking "PLAY" after character creation and ends on the last hit on Traya as the screen fades to black, at the end of the final run. A load-removal tool is available for LiveSplit thanks to glasnonck; since load times vary significantly in this game, and saving is frequent. This guide will cover the character build for the runs, as well as detailed routes.
At the time of creation, this route is not a recognised run on Speedrun.com and is merely a challenge run.
...
- [Run 1: Male Exile](#run-1:-male-exile)
	- [Character Build](#character-build)
  	...
  	- [Achievement Plan](#achievement-plan)
...
Computer Use - Required to reach 15.
Persuade - Required to reach 30.
...
**Item Prioritization:**
- Due to the RNG nature of loot and shops in this game, sometimes there are better items you might find on your way through the early game. You'll want to prioritize it roughly by:
...
### Dormitories
- Dormitory Door: 2,4,2
- Run your way through to the last room where the 3 corpses are.
- Loot the 3 corpses and use the Turbolift Console: 1,2,7,5,13,17,3,2
...
- Some dialog will trigger: 4,1,1,3
...
- Kreia accosts you: 3
- Medical Console: 1,1,3
- Kreia Repair Healing Droid.
- Cast Burst of Speed and run your way through to Harbinger Engine Deck.
- Atton has a bad feeling about this: 2,2,1
...
- Decontamination Console as T3: 1,2,1,1,2
...
- Let Sith Troopers board the Ebon Hawk, then kill for XP: 1

## Ebon Hawk to Telos
- Immediate dialog cutscene after the load screen: 1,2,3 -> 4,3,3 (+1 LSP -> +1 LSP)
...
- Speak to Jana Lorso about Batono: 2,1,1,3
- Cast Burst of Speed.  `\ \`
...
- Handmaiden Sister: 1x5,3,1,2 -> 1,1,1
- All Handmaidens fights: 1x-
- Free Party Members:
- Kreia: 2,1,1,2,4
- Atton: 2,3
- Bao-Dur: 1,1,2,1,1
...
- Disciple talks to you: 2,4,4,5
- `=` Remove Disciple from your party when prompted, add Kreia.
...
- Continue to the door that Jorran is behind. Making sure there are no Laigrek's.
- Let Jorran out: 1,3
...
- Head back to where Vrook is captured by the Mercenaries: 1,2
- Cast Force Valor.  `\`
- Cast Burst of Speed.  `\`
- Defeat the Mercenaries.
- Vrook accosts you: 1,1,3  `\`
- Exit the Crystal Cave.

### Defense of Khoonda
- Azkul talks to you: 3,2,2
- Cast Burst of Speed.  `\`
...
- Speak to Akkere (Bao-Dur Influence): 5,1,1,2  `\ \`
- Wait until T3 speaks to you: 1x-
- Enter Khoonda.
- Administrator Adare: 2,3
...
- Following conversation: 1,1 -> 3,1 -> 1
...
- Kreia:
- (You have befriended the Seer) - 1x6,2
- (Too many companions) - 1x6,3
- (Listen Lesson 1) - 1,2,1x-
- (Skills) - 1,2,1,1,3,1,2 -> 1,3,1,1
- (Listen Lesson 2) - 1,2,1x6,2
...
- T3-M4
- Be nice, ask about Jedi Masters List, uipgrade him with Computer Use and Repair
- (Intelligence Option) - 1,2,1x5,4,2,1,1,5
- (Computer - Repair - Computer) - 5,1x9,5,1x5,5,1x4,2
- (Jedi Master's List) - 4,1,2,2
...
- Visas:
	- *Make sure you have Wisdom of at least 16, can do this through Lightsaber crystals, MC's LS Crystal etc.*
	- *Level 16 Level up Wisdom from 11 to 12, only need +4 in bonus wisdom, can also gain through gear.*
	
- (Force Sight) - 1x9 3,1,2,2,1,1,2,4,1,1,1,4,1,2,1,1,2
- Cast Burst of Speed, run and speak to T3 to get more computer spikes: 6,2x-
- Head to the Galaxy Map and fly to Nar Shaddaa.
...
- 5,6 -> 6,5,3
- `=` Select Kreia and Handmaiden when prompted.
- `+` Cast Knight Speed.
...
- Updated the Wayward Captain quest's route to be faster.
