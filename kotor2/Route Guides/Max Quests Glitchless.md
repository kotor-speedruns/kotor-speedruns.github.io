[center]
	[big][big]Star Wars: Knights of the Old Republic II - The Sith Lords[/big][/big]
	[big]Max Quests Glitchless Guide v1.7: Female Jedi Guardian Route[/big]
[/center]
...
[Any% Glitchless](https://www.speedrun.com/kotor2/guide/l8dx3) route, without their hard work this route would have been 10 times harder to make happen. I would also like to thank [AtomicHeartSon](https://www.speedrun.com/user/AtomicHeartSon), for jumping in and beginning the routing progress for this category, it wouldn't be where it is today without his initial eagerness to bring this to life.*
...
TI + 4 (Pressing recommended will do this for you, as is the same for all level ups.)
...
We choose 'Weapon Focus: Melee Weapons' for the attack boost before getting our lightsaber; we pick it over 'Two-Weapon Fighting' since this feat takes longer to select and character creation isn't timed. This will in turn result in our first level up being faster than if we chose 'Two-Weapon Fighting' now. 
...
2. 'Dominate Mind' persuades Captain Bostuco to leave his post during Onderon 1.
3. It is required that we have 'Dominate Mind' in order to complete the 'Lupo's Advantage' quest on Nar Shaddaa.
...
The first shopping trip of the run will start with Samhan. Please note that at the end of the Telos Station shopping trip we MUST have at minimum 2000 credits to complete the 'High Stakes' quest.
In Samhans shop we will sell the following:
- 2x Parts (+220 credits)
- 2x Vibroblades (+208 credits)
- 2x Deadly Sonic Mines (+440 credits)
- Droid Self-Sustaining Unit (+3300 credits)
- Droid Ion Blast Mark 1 (+1086 credits)
- Droid Ion Striker (+467 credits)
This will bring our credit total anywhere between 6000 and 6500 credits.
We are allocating 2450 credits for the bare essentials, but we will usually spend a bit less than that here.
Next is to buy some essential items that will get us through until the end of Dxun/Onderon 1. We are only buying enough items here to end at the total amount given below:
(e.g. If you have 2 Strength stims and you need 10, only buy 8)
- 2x Ion Grenades (-260 credits)
- 3x Frag Grenades (-240 credits)
- 1x Hyper Alacrity (-100 credits)
- 2x Hyper Stamina (-200 credits)
- 13x Alacrity (-650 credits)
- 10x Stamina (-500 credits)
- 10x Strength (-500 credits)
This will leave us at a credit total of approximately 4000 credits
- You can buy any light/medium armor under 1,000 credits. This will be for Bao-Dur later. Although you can get away with skipping this and using the Mining Uniform on Bao-Dur at the cost of using a few more medpacs. This guide will account for that, more on that in a later segment below. (If you buy the Sith War Sword you will only be able to afford the Combat Suit which is 50 credits, but that also depends if it shows up in the shop.)

2: **Dendis Dobo**; Telos Station
Buy: Enough Medpacs to have between 30 to 35 total, just remember to be mindful of your credit total whilst doing this as so to keep it above 2025 credits. You may need to buy less medpacs depending on the cost of the armor you purchased for Bao-Dur.

3. **Adum Larp**; Dantooine
This shopping trip is a quick one, although we may need to buy some extra medpacs here, this will depend on the total number of medpacs we have before starting this shopping trip. First off we will sell:
- Exchange Negotiator (+467 credits)
- Benok's Blaster (+660 credits)
- Any extra armor you may have purchased for Bao-Dur (This is not essential here unless you are short on credits / medpacs)
We will buy: 
- 4x Advanced Medpacs (-320 credits)
- 10x Medpacs (-400 credits)
- 12x Battle Stims (-1200 credits)
...
1. 2x Parts. Left over from Peragus, helps to fund our first shopping trip
2. 2x Vibroblades. Obtained on Peragus, sold to help fund our stim needs.
3. 2x Deadly Sonic Mines. Left over from Peragus, also helps fund our first shopping trip.
4. Droid Self-Sustaining Unit. Obtained from HK-50 on Peragus, this is a big chunk of credits for our shopping trip on Telos.
5. Droid Ion Blast Mark 1. Picked up at some point on Peragus, this gives us half the credits we need for the 'High Stakes' quest. 
6. Droid Ion Striker. Picked up at some point on Peragus, helpful to sell for extra credits on Telos.
7. Exchange Negotiator. Obtained from Luxa and is used to help fund our stim needs.
8. Benok's Blaster. Obtained at the same time as the Exchange Negotiator from Luxa and is also used to help fund our stim needs.
9. Mandalorian Blaster Rifle. Obtained from Mandalore the second time we talk to him on Dxun. This needs to happen before we complete the 'Battle Circle' quest. If you don't have this item to sell on Onderon, your run ends.

[section=Alignment Route]

Alignment in KotOR is a sliding scale from 0 to 100, initialized at 50; higher numbers are Light, where lower numbers are Dark. Shifts in alignment are determined by a matrix; every alignment-shifting action is classified as Light or Dark, and then assigned a level (either Low, Mid, or High). The MC (The Exile) can either be aligned as Very Dark, Dark, Neutral, Light, or Very Light. The more opposed your alignment and the action's classification, the more drastic your shift in alignment; for example, a Light-aligned character performing a High Dark action will have a large shift, while a Dark character performing a High Dark action will have a smaller shift.
...
Since we have the option to side with Czerka or the Ithorians on Telos Station, and Czerka has one more quest to complete there, we have implemented two different Telos Routes for the run. Both will be their own seperate sub category and will need to be submitted to the leaderboards with the appropriate information. If completing the run on the Ithorians side, at the end of the run you will have 103 quests complete, versus Czerka being 104. It is recommended to start with the Czerka Route.
...
Use security on the first door.
Use security on the door to the med bay.
Use security on the Metal Box for medpacs.
Heal MC.
Use the Utility Lift: 1
Get 1 Frag Mine from the Proton Missile
Loot 2 Open Hatches and the Engine Port for 5 total Parts.
Use the Utility Lift: 1
Use the mine on the Engine Room Door and immediately head for the Cargo Hold.
Use Security to open the Cargo Hold.
Speak to 3C-FD.
Put T3 at the Outer Garage door and go into solo mode.
\  As 3C-FD repair the Hyperdrive.
Head back into the Main Hold and use the Security Console: 1,2,1,2,5
\  As T3 open the workbench: 2
Breakdown 1 item, make 1 repair kit and exit the workbench.
\  As 3C-FD go back to the Cockpit and skip the Prologue: 2
...
Head into the morgue and loot the Corpse for the Plasma Torch.
Kreia wakes up and speaks to you: 1x- (+1 LSP)
} Plasma Torch.
...
Kreia accosts you: 1x-  >   * *perform your first level up.*
...
Open the Door.
Spam 1 through Atton Dialog until you have control of MC again. (+1 LSP)
Use the Console: 2x- -> 2x-


**Fuel Depot - T3 Section**
* *Do not click your mouse until you can see T3 or your game will crash!*
Now as T3 we want to head down to get 3 Deadly Sonic Mines and Parts in order to blow open a door to get a Computer Spike.
(Optional) Loot Broken Droid for a repair kit.
Use Security on the Door.
Head straight down and go into Fuel Depot.
Go through 2 doors and loot the Corpse and the Broken Droid for Mines and Parts.
Head back to the first room you were in and blow open the door with a Mine.
Loot the Footlocker for a Computer Spike.
Use Security on the last door.
Move forward to trigger cutscene: Mouse spam
...
Exit the Mining Tunnels to the Fuel Depot.
Mouse spam until HK-50 talks to you: 7
...
* *In a proper run we want to have at least 1 Alacrity stim in our inventory at this point. Otherwise the final run to the Ebon Hawk after the Harbinger will be slow. It is recommended while learning this route that you don't focus on this and just continue regardless.*
...
* *Do not enter The Harbinger until you have looted the HK-50.*
\  Loot HK-50  \ \ 
* *If you don't loot the HK-50 you cannot complete the run as you won't be able to rebuild HK-47.*
Enter Harbinger.
...
Click on the Main Ion Engine Control console: 1 -> 1
...
Run through to the ramp where we were as T3 earlier.
...
[section=Ebon Hawk to Telos]
Immediate dialog cutscene after the load screen: 6,2 -> 4,4 (+1 LSP)
Cast Burst of speed, turn around and run through to the right to where Kreia resides on the Ebon Hawk.
* *Now we have quite a lengthy conversation with Kreia so it is a good idea when learning to make a save here just incase you make a mistake, this will give us +8 alignment points, if not done correctly you will not be able to finish Korriban.*
Speak to Kreia: 2x7,1,3,1x10,4,3,2,1x6,2,1 (+8 LSP)
Now run back to the Cockpit and speak to Atton: 1x-
Afterwards use the Galaxy Map and select Telos.
...
Run MC to TSF.
Thugs accost you: 1,1,2,1 (+3 LSP)
...
- 2x Parts
- 2x Vibroblades
- 2x Deadly Sonic Mines
- Droid Self-Sustaining Unit
- Droid Ion Blast Mark 1
- Droid Ion Striker
...
• **Optional:** *Buy one light/medium armor under 1000 credits for Bao-Dur. This will effect how many Medpacs we can buy from Dendis.*
Speak to Dendis: 1

Buy:
- 35-40 Medpacs

• *Or less depending on cost of armor for Bao-Dur.*
• *Make sure to end with >2025 credits so we can finish the 'High Stakes' quest.* \
...
Run to Czerka Docking Bay speak to the 2 workers there. 1x- | 1x- + \  (+1 DSP)
...
Jana thanks you and then asks you to do another task: 1,1,1,1 (+2 DSP)
\ Cast Burst of Speed. \ \ 
Try to speak to one of the escaped criminals: 1x-
...
* *The above options change if you have accidentally opened the door to B2 previously in the run.*
...
• *This completes the High Stakes quest.* (+1 LSP)
Cast Burst of Speed.
...
• *We will now be teleported to Lt. Grenn:* 1x- (+1 LSP)
Finish the Bounty Quests with Lt. Grenn: 1x- +
Make Kreia cast Burst of Speed.
Run to Samhan to finish the Smuggling quest: 1x- (+1 LSP)
Once back at TSF, make Kreia cast Burst of Speed and head to the Information Terminal to transit to 082 East: 2,2
...
**Continue at [Telos Surface](https://www.speedrun.com/kotor2/guide/nqnvz#ch16Telos_Surface)**

[section=Telos - Ithorian Route]
**Telos Citadel Station**
Lieutenant Grenn accosts you: 3,2,1
* *Handmaiden steals the Ebon Hawk cutscene.*
...
Open the door to B2 to get the Droid Credentials from Opo Chano: 1,2,2,2,2  \  (+2 DSP)
Cast Burst of Speed.
Open the door to apartment C1 to speak to Batono: 1x- \ \
* *To trigger the dialog with the Thugs you must cross the entrance/exit to the C Apartments complex.*
Thugs accost you: 2
...
**Restoration Zone**
* *This section, besides the Polar Plateau, is the same as the Sanjan's Any% - Glitchless route. If you already know that route it will help here, if not the description is below.*
...
**Polar Academy**
Handmaiden talks to you: 2 (+1 LSP)
* *On legacy client you need to do '1,3', since the option above softlocks you.*
Atris talks to you: 5,1,6,4
Once Atris door closes, cast Burst of Speed and head to the prison room: 1,7,1 -> 1x-
When party selection is prompted, take no one. (+1 LSP)
Head towards the Ebon Hawk, T3 accosts you: 1x- -> 1 (+1 LSP)
...
* *Dantooine is one click to the left with the arrow keys.*
...
Let Jorran out: 1,3  (+6 DSP)
Loot his corpse when he dies.
...
+ Speak to Suurlu to complete Farm Equipment quest: 1x-  (+3 LSP)
...
Mouse spam through Vrook teaching you Ataru. (+8 DSP)
...
Enter Iziz Cantina.
+  \ Cast Knight Speed.
Run through past Kiph into the east room, speak to Panar twice: 1x- | 2,1,1,1  \ \  (+6 DSP)
Exit to Western Square.  \ \
+ Cast Knight Speed.
...
Kavar conversation: 1x- -> 1x- (+2 LSP)
...
Following conversation: 1,1 -> 4,1 -> 1 (+3 LSP)
Cast Knight Speed.
Fly to Nar Shaddaa, Atton says something about Nal Hutta: 5

[section=Nar Shaddaa 1]
...
Exchange Thugs: 4,2 (+2 LSP)
Continue towards the door ahead.
Beggar accosts you: 1 -> 4 (+2 LSP)
...
= Add T3 to Party. 
Access the Interface Computer: 1x-  (+1 DSP)
Speak to Borna Lys.
...
**Refugee Sector**
Cast Knight Speed.
Run to the 2 Exchange Thugs hassling a Refugee: 3  + (+1 LSP)
Head towards Refugee Sector.
Kreia accosts you: 1x-
Ratrin Vhek accosts you: 1x- (+2 LSP)
Enter the Refugee Sector.
+ Cast Knight Speed, open the door.
Exchange Thugs accost you: 4,2
Head through the door on the left and proceed down the 2 ramps, turn right and speak to Geriel: 1x- -> 1 (+1 LSP)
...
Speak to Saquesh twice: 1,2,1,1 | 4 (+1 LSP | +1 LSP)
...
Head down and speak to Aiida: 1x-  \ \ (+2 LSP)
...
\ \ Speak to Oondar for the last time: 1x- (+1 LSP)
Cast Burst of Speed.
...
Run MC to the Lunar Shadow Crewmen, speak to the one at the back: 1,3,1,1 (+1 LSP)
...
Run and speak to Visas: 1,1,1,4,1,1,3 (+4 LSP)
Run and speak to Kreia: 4,5,1x4,2 (+1 LSP)
Fly to Korriban.
...
The second dialog set will ask Tien Tubb to change the Ebon Hawk's Transponder Codes, then to choose two party members to travel to Goto’s Yacht. We choose to bring Mira and
Visas.
Tien Tubb: 1,1 -> 5,6
...
Defeat Atris.
Atris: 3
Mouse and 1 spam until load screen.
...
Trigger the dialog with Mandalore and Visas: 1,1
= Click OK.
+ Cast Knight Speed.
...
**v1.5 (September 2022)**
- Re-named to Max Quests Glitchless.
- Added Czerka Route as the main route for Telos with 103 Quests completed at end of run.
- Ithorian Route is now optional with 102 Quests completed at end of run.
- Added 2 hidden Pazaak Quests with Atton that were unknown to the community.
- Updated the Wayward Captain quest's route to be quicker and more streamline with less backtracking.
- Moved Korriban to after Nar Shaddaa 1.
- Updated the alignment route to be exactly 75 for the Sith Tomb on Korriban.

**v1.0 (August 2022)**
- Named All Quests Glitchless.
- 100 Total Quests in the run.
- Ithorian Route only since it was fastest at the time.
- Korriban last planet to be completed.
- Alignment route at 76 for Sith Tomb on Korriban.